...
#PATH_SCALER_LOAD="./models/best_models/pwelch/dataset1/tst_outlTH_0.3_cont_auto/" # path where to load the scaler models 
PATH_SCALER_LOAD="./models/best_models/examon/dataset1/tst_outlTH_0.3_cont_auto/" # path where to load the scaler models 
PATH_PCA_STORE="./models/" # path to store the PCA models 
#PATH_PCA_LOAD="./models/best_models/pwelch/dataset1/tst_outlTH_0.3_cont_auto/" # path where to load the PCA models 
PATH_PCA_LOAD="./models/best_models/examon/dataset1/tst_outlTH_0.3_cont_auto/" # path where to load the PCA models 
PATH_CLF_STORE="./models/" # path to store the IF models 
#PATH_CLF_LOAD="./models/best_models/pwelch/dataset1/tst_outlTH_0.3_cont_auto/" # path where to load the IF models 
PATH_CLF_LOAD="./models/best_models/examon/dataset1/tst_outlTH_0.3_cont_auto/" # path where to load the IF models 
METRIC=1 # Which metric to use for the analysis, namely 0=pwelch, 1=examon, 2=all
...
PCA=0 # Run or not the PCA, namely 1=run_PCA, 0=do_not_run_PCA
...
START_WELCH=250 # Index where PSD pwelch start
...
for iB in range(0,N_BENCH_TO_TEST):
  ...
  ### Test dataset w. Isolation Forest
  if TRAINING==1: # Training
